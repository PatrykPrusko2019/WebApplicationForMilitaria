...
{
    public class CreateThirdProviderOneFileCommandValidator : AbstractValidator<CreateThirdProviderOneFileCommand>
    {
        public CreateThirdProviderOneFileCommandValidator()
        {
