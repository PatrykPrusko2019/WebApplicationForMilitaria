...
{
    public class EditSecondProviderTwoFileCommandValidator : AbstractValidator<EditSecondProviderTwoFileCommand>
    {
        public EditSecondProviderTwoFileCommandValidator()
        {
